                    ...
                    <ul className="templateCardList clearfix">
                        {
                            me.state.cardList.map(function (item, i) {
                                return <li className="templateCardItem" draggable={true} onDragStart={me.onDragStart.bind(me, item)} onDragEnter={me.onDragEnter} onDragOver={me.onDragOver} onDrop={me.onDrop.bind(me, item)} onDragLeave={me.onDragLeave} key={`templateCardItem${i}`}>
                                    <CardItem data={item} />
