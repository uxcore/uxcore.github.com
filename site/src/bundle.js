...
/***/ function(module, exports, __webpack_require__) {
	...
	{ value: 'forms', label: 'Forms' }, { value: 'home', label: 'Home' }];
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement('div', { className: 'demo-container container' })
				)
			);
		}
	});

	var __location = window.location.pathname,
	    devmode = false,
	    rootPath = '/';
	...
	var routes = React.createElement(
		Route,
		{ path: rootPath, handler: App },
		React.createElement(Route, { name: 'home', path: 'home', handler: __webpack_require__(47) }),
		React.createElement(Route, { name: 'forms', path: 'forms', handler: __webpack_require__(48) }),
		React.createElement(Router.DefaultRoute, { handler: __webpack_require__(47) })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Router = __webpack_require__(2);
	var UXForm = __webpack_require__(49);
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(InputFormField, { label: '姓名', keyMap: 'name', rules: { required: true, message: 'not empty' } }),
						React.createElement(InputFormField, { label: '岗位', keyMap: 'job' }),
						React.createElement(TextAreaFormField, { label: '简介', keyMap: 'introduce' }),
						React.createElement(
							RadioGroupFormField,
						...
						React.createElement(InputFormField, { label: '啦啦', keyMap: 'lala' }),
						React.createElement(
							SelectFormField,
						...
						React.createElement(Button, { label: '提交' })
					)
				),
				React.createElement(
					'div',
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							FormRow,
							null,
							React.createElement(InputFormField, { className: 'one-half', label: '姓名', keyMap: 'name', tips: '中文名称', rules: { required: true, message: 'not empty' } }),
							React.createElement(InputFormField, { className: 'one-half', label: 'Email', keyMap: 'email', tips: 'Email格式', rules: { required: true, type: 'email', message: 'should be email' } })
						),
						React.createElement(
							FormRow,
							null,
							React.createElement(InputFormField, { className: 'one-half', label: '岗位', keyMap: 'job' }),
							React.createElement(InputFormField, { className: 'one-half', label: '岗位', keyMap: 'job2' }),
							React.createElement(InputFormField, { className: 'one-half', label: '岗位', keyMap: 'job3' }),
							React.createElement(InputFormField, { className: 'one-half', label: '岗位', keyMap: 'job4' })
						),
						React.createElement(
							FormRow,
							null,
							React.createElement(TextAreaFormField, { className: 'one-half', label: '简介', keyMap: 'introduce' }),
							React.createElement(
								RadioGroupFormField,
						...
						React.createElement(
							FormRow,
							null,
							React.createElement(InputFormField, { className: 'one-half', label: '啦啦', keyMap: 'lala' }),
							React.createElement(
								SelectFormField,
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							FormRow,
							null,
							React.createElement(InputFormField, { className: 'one-third', label: '姓名', keyMap: 'name', rules: { required: true, message: 'not empty' } }),
							React.createElement(InputFormField, { className: 'one-third', label: '年龄', keyMap: 'job' }),
							React.createElement(InputFormField, { className: 'one-third', label: '性别', keyMap: 'job' })
						),
						React.createElement(TextAreaFormField, { label: '个人简介', keyMap: 'introduce' }),
						React.createElement(Button, { label: '提交' })
					)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputFormField = __webpack_require__(54);

	var _inputFormField2 = _interopRequireDefault(_inputFormField);

	var _textAreaFormField = __webpack_require__(58);
	...
	var _formRow = __webpack_require__(59);
	...
	var _radioGroupFormField = __webpack_require__(62);

	var _radioGroupFormField2 = _interopRequireDefault(_radioGroupFormField);

	var _SelectFormField = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputFormField = (function (_FormField) {
	    ...
	    _createClass(InputFormField, [{
	        ...
	        value: function render() {
	            var _mode = undefined;
	            var className = (0, _classnames2['default'])(this.props.bsStyle, this.props.className);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formfieldMixin = __webpack_require__(56);
	...
	var _customValidatorType = __webpack_require__(57);
	...
	var FormField = (function (_React$Component) {
	    ...
	    _createClass(FormField, [{
	        ...
	        value: function render() {
	            ...
	            var _mode = undefined;
	            var className = (0, _classnames2['default'])('kuma-form-item', this.props.className);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _formfieldMixinJs = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uxcoreRadiogroup = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _uxcoreSelect = __webpack_require__(66);
